...
if (superfish.b && superfish.b.qsObj && superfish.b.qsObj.sflog == "-999") {
    if(!correctJqVersion) {
        ...
        superfish.b.appVersion="12.2.4.5";
...
superfish.b.logoText='WindowShopper';
...
;
    ...
    getRelTextPiP : function( node, gLN, tFL ){
        var relTxt = {
            prodUrl: "",
            iText: ""
        };
